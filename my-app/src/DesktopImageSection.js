...
export default function DesktopImageSection({ imgs }) {
    ...
    const images = imgs.map((img, index) => {
        ...
        const activestyle = img.naturalWidth / img.naturalHeight > window.innerWidth / window.innerHeight ? // img proportionally wider than window ?
